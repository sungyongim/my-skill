...
- Slack: 어제 발신 메시지 N건 + 최근 3일 수신 멘션 N건
- Confluence: 어제 수정 페이지 N건
- Jira: 담당 이슈
- 로컬 파일: ~/Documents/지식창고
```
...
- Step 4에서 Confluence 페이지를 갱신할 때 이 섹션도 함께 포함된다.
